  ...
  return (
    <Card sx={{ maxWidth: 300 }}>
      ...
      <CardActions className="!px-4 my-2">
        <button className=" rounded px-3 py-1.5  overflow-hidden group bg-indigo-500 relative hover:bg-gradient-to-r hover:from-indigo-500 hover:to-indigo-400 text-white hover:ring-1 hover:ring-offset-1 hover:ring-indigo-400 transition-all ease-out duration-300">
